      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl text-white">NachyStitches</h3>
            <p className="text-sm leading-relaxed">
              Your go-to fashion home for ready-to-wear Ankara outfits. Modern. Elegant. Convenient.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-orange-400 transition-colors">All Collections</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-orange-400 transition-colors">Styling Services</a></li>
          ...
          <div>
            ...
            <div className="mt-6">
              <p className="text-sm mb-2">Call or WhatsApp:</p>
              <a href="tel:+234" className="text-orange-400 hover:text-orange-300">+234 XXX XXX XXXX</a>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-800 pt-8 text-center text-sm">
          <p>&copy; 2026 NachyStitches. All rights reserved. Designed for the stylish Nigerian woman.</p>
        </div>
      </div>
    </footer>
  );
